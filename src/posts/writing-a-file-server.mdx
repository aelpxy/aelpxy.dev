...
author: 'aelpxy'
summary: 'A very experimental design for a file server that is not meant for production.'
isDraft: false
---
...
Just SQLite as the database, keeping in mind that this is a simple
