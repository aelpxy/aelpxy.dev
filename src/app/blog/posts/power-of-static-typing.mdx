...
author: 'Aelpxy'
summary: 'There's a long debate about static dynamic typing in the world of software. Let's explore why static typing is superior.'
---

## Why should you care?

The developers who write dynamic languages always argue how easy it is to get
started. However, once they turn into statically typed languages, it's actually
hard for them into dynamic languages. Languages like JavaScript, Python, and
many others don't care about type safety and thus throw really bad runtime
...
Perhaps that looks like a lot but if you trust me that will save you a lot of
time and headache. Plus, you'll endjoy free autocompletion provided by the
language server.
